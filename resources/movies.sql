...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Shawshank Redemption','Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.',the-shawshank-redemption.jpg,1994,1,'Andy Dufresne, Ellis Boyed Red Redding, Warden Norton',142,'R','Frank Darabont','Stephen King, Frank Darabont','Tim Robbins, Morgan Freeman, Bob Gunton')
insert into movie_genre (movie_id, genre_id) values (1,1);
insert into movie_genre (movie_id, genre_id) values (1,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Godfather','The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.',the-godfather.jpg,,1972,1,'Don Vito Corleone, Michael Corleone, Sonny Corleone',175,'R','Francis Ford Coppola','Mario Puzo, Francis Ford Coppola','Marlon Brando, Al Pacino, James Caan')
insert into movie_genre (movie_id, genre_id) values (2,1);
insert into movie_genre (movie_id, genre_id) values (2,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Godfather Part II','The early life and career of Vito Corleone in 1920s New York is portrayed while his son, Michael, expands and tightens his grip on his crime syndicate stretching from Lake Tahoe, Nevada to pre-revolution 1958 Cuba.',the-godfather-part-ii.jpg,,1974,1,'Michael, Tom Hagen, Kay',200,'R','Francis Ford Coppola','Mario Puzo, Francis Ford Coppola','Al Pacino, Robert De Niro, Robert Duvall')
insert into movie_genre (movie_id, genre_id) values (3,1);
insert into movie_genre (movie_id, genre_id) values (3,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Dark Knight','When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the caped crusader must come to terms with one of the greatest psychological tests of his ability to fight injustice.',the-dark-knight.jpg,,2008,1,'Bruce Wayne, Joker, Harvey Dent',152,'PG','Christopher Nolan','Jonathan Nolan, Christopher Nolan','Christian Bale, Heath Ledger, Aaron Eckhart')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('One Flew Over the Cuckoos Nest','Upon admittance to a mental institution, a brash rebel rallies the patients to take on the oppressive head nurse.',one-flew-over-the-cuckoos-nest.jpg,1975,1,'Ellis, Col. Matterson, Dr. Spivey',133,'R','Milos Forman','Lawrence Hauben, Bo Goldman','Jack Nicholson, Louise Fletcher, Michael Berryman')
insert into movie_genre (movie_id, genre_id) values (15,2);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Lord of the Rings The Two Towers','While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the divided fellowship makes a stand against Saurons new ally, Saruman, and his hordes of Isengard.',the-lord-of-the-rings-the-two-towers.jpg,,2002,1,'Aldor, Sam, Madril',179,'PG','Peter Jackson','J.R.R. Tolkien, Fran Walsh',' Elijah Wood, Ian McKellen, Viggo Mortensen')
insert into movie_genre (movie_id, genre_id) values (16,7);
insert into movie_genre (movie_id, genre_id) values (16,8);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Goodfellas','Henry Hill and his friends work their way up through the mob hierarchy.',goodfellas.jpg,,1990,1,'James Conway, Henry Hill, Tommy DeVito',146,'R','Martin Scorsese','Nicholas Pileggi', 'Robert De Niro, Ray Liotta, Joe Pesci')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Seven Samurai','A poor village under attack by bandits recruits seven unemployed samurai to help them defend themselves.',seven-samurai.jpg,,1956,1,'Kikuchiyo, Kambei Shimada, Shino',207,'NR','Akira Kurosawa','Akira Kurosawa, Shinobu Hashimoto','Toshirô Mifune, Takashi Shimura, Keiko Tsushima')
insert into movie_genre (movie_id, genre_id) values (20,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('City of God','Two boys growing up in a violent neighborhood of Rio de Janeiro take different paths: one becomes a photographer, the other a drug dealer.',city-of-god.jpg,,2002,1,'Buscapé - Rocket, Zé Pequeno - Lil Zé, Bené - Benny',130,'R','Fernando Meirelles, Kátia Lund',' Paulo Lins, Bráulio Mantovani',' Alexandre Rodrigues, Matheus Nachtergaele, Leandro Firmino')
insert into movie_genre (movie_id, genre_id) values (21,1);
insert into movie_genre (movie_id, genre_id) values (21,2);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Se7en','Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his modus operandi.',se7en.jpg,,1995,1,'Somerset, Dead Man at 1st Crime Scene, Detective Taylor',127,'R','David Fincher','Andrew Kevin Walker','Morgan Freeman, Brad Pitt, Kevin Spacey')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Silence of the Lambs','A young F.B.I. cadet must confide in an incarcerated and manipulative killer to receive his help on catching another serial killer who skins his victims.',the-silence-of-the-lambs.jpg,,1991,1,'Clarice Starling, FBI Instructor, Ardelia Mapp',118,'R','Jonathan Demme',' Thomas Harris, Ted Tally','Jodie Foster, Anthony Hopkins, Lawrence A. Bonney')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Usual Suspects','A sole survivor tells of the twisty events leading up to a horrific gun battle on a boat, which begin when five criminals meet at a seemingly random police lineup.',the-usual-suspects.jpg,,1995,1,'McManus, Keaton, Fenster',106,'R','Bryan Singer','Christopher McQuarrie','Kevin Spacey, Gabriel Byrne, Chazz Palminteri')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Léon The Professional','Mathilda, a 12-year-old girl, is reluctantly taken in by Léon, a professional assassin, after her family is murdered. Léon and Mathilda form an unusual relationship, as she becomes his protégée and learns the assassins trade.',léon-the-professional.jpg,,1994,1,'Léon, Stansfield, Mathilda',110,'R','Luc Besson,Luc Besson','Jean Reno, Gary Oldman, Natalie Portman')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Saving Private Ryan','Following the Normandy Landings, a group of U.S. soldiers go behind enemy lines to retrieve a paratrooper whose brothers have been killed in action.',saving-private-ryan.jpg,,1998,1,'Captain Miller, Sergeant Horvath, Private Reiben',169,'R','Steven Spielberg,Robert Rodat,'' Tom Hanks, Matt Damon, Tom Sizemore')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Spirited Away','During her familys move to the suburbs, a sullen 10-year-old girl wanders into a world ruled by gods, witches, and spirits, and where humans are changed into beasts.',spirited-away.jpg,,2001,1,'Chihiro Ogino / Sen, Haku, Yubaba / Zeniba',125,PG,Hayao Miyazaki,Hayao Miyazaki,' Daveigh Chase, Suzanne Pleshette, Miyu Irino')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Psycho','A Phoenix secretary steals $40,000 from her employers client, goes on the run and checks into a remote motel run by a young man under the domination of his mother.',psycho.jpg,,1960,1,'Norman Bates, Lila Crane, Sam Loomis',109,R,Alfred Hitchcock,'Joseph Stefano, Robert Bloch','Anthony Perkins, Janet Leigh, Vera Miles')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Raiders of the Lost Ark','Archaeologist and adventurer Indiana Jones is hired by the US government to find the Ark of the Covenant before the Nazis.',raiders-of-the-lost-ark.jpg,1981,1,'Indy, Marion Ravenwood, Dr. René Belloq',115,'PG','Steven Spielberg','Lawrence Kasdan, George Lucas','Harrison Ford, Karen Allen, Paul Freeman')
insert into movie_genre (movie_id, genre_id) values (36,3);
insert into movie_genre (movie_id, genre_id) values (36,7);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Rear Window','A wheelchair bound photographer spies on his neighbours from his apartment window and becomes convinced one of them has committed murder.',rear-window.jpg,,1954,4,'L.B. 'Jeff' Jefferies, Lisa Carol Fremont, Det. Lt. Thomas J. Doyle',112,'Approved' ,'Alfred Hitchcock','John Michael Hayes, Cornell Woolrich','James Stewart, Grace Kelly, Wendell Corey')
insert into movie_genre (movie_id, genre_id) values (37,10);
insert into movie_genre (movie_id, genre_id) values (37,12);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Intouchables','After he becomes a quadriplegic from a paragliding accident, an aristocrat hires a young man from the projects to be his caregiver.',the-intouchables.jpg,,2011,1,'Philippe, Driss, Yvonne',112,'R','Olivier Nakache, Eric Toledano',' Olivier Nakache, Eric Toledano','François Cluzet, Omar Sy, Anne Le Ny')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Modern Times','The Tramp struggles to live in modern industrial society with the help of a young homeless woman.',modern-times.jpg,,1936,1,'A Factory Worker, A Gamin, Cafe Proprietor',87,'G', 'Charles Chaplin, Charles Chaplin,''Charles Chaplin, Paulette Goddard, Henry Bergman')
insert into movie_genre (movie_id, genre_id) values (39,14);
insert into movie_genre (movie_id, genre_id) values (39,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Green Mile','The lives of guards on Death Row are affected by one of their charges: a black man accused of child murder and rape, yet who has a mysterious gift.',the-green-mile.jpg,,1999,1,'Paul Edgecomb, Brutus Howell, John Coffey',189,'R','Frank Darabont','Stephen King, Frank Darabont',' Tom Hanks, Michael Clarke Duncan, David Morse')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('The Departed','An undercover cop and a mole in the police attempt to identify each other while infiltrating an Irish gang in South Boston.',the-departed.jpg,,2006,1,'Billy, Colin Sullivan, Frank Costello',151,'R','Martin Scorsese','William Monahan,  Alan Mak',' Leonardo DiCaprio, Matt Damon, Jack Nicholson')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Memento','A man creates a strange system to help him remember things so he can hunt for the murderer of his wife without his short-term memory loss being an obstacle.',memento.jpg,,2000,1,'Leonard, Natalie, Teddy',113,'R','Christopher Nolan','Christopher Nolan, Jonathan Nolan',' Guy Pearce, Carrie-Anne Moss, Joe Pantoliano')
insert into movie_genre (movie_id, genre_id) values (45,10);
insert into movie_genre (movie_id, genre_id) values (45,12);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Back to the Future','A young man is accidentally sent 30 years into the past in a time-traveling DeLorean invented by his friend, Dr. Emmett Brown, and must make sure his high-school-age parents unite in order to save his own existence.',back-to-the-future.jpg,,1985,1,'Marty McFly, Dr. Emmett Brown, Lorraine Baines',116,'PG','Robert Zemeckis,''Robert Zemeckis, Bob Gale','Michael J. Fox, Christopher Lloyd, Lea Thompson')
...
insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Gladiator','When a Roman general is betrayed and his family murdered by an emperors corrupt son, he comes to Rome as a gladiator to seek revenge.',gladiator.jpg,,2000,1,'Maximus, Commodus, Lucilla',155,'R','Ridley Scott,''David Franzoni, David Franzoni',' Russell Crowe, Joaquin Phoenix, Connie Nielsen')
insert into movie_genre (movie_id, genre_id) values (47,3);
insert into movie_genre (movie_id, genre_id) values (47,2);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Apocalypse Now','During the Vietnam War, Captain Willard is sent on a dangerous mission into Cambodia to assassinate a renegade colonel who has set himself up as a god among a local tribe.',apocalypse-now.jpg,,1979,1,'Colonel Walter E. Kurtz, Captain Benjamin L. Willard, Lieutenant Colonel Bill Kilgore',153,'R','Francis Ford Coppola','John Milius, Francis Ford Coppola',' Martin Sheen, Marlon Brando, Robert Duvall')
insert into movie_genre (movie_id, genre_id) values (48,2);
insert into movie_genre (movie_id, genre_id) values (48,15);

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Dr. Strangelove or How I Learned to Stop Worrying and Love the Bomb','An insane general triggers a path to nuclear holocaust that a war room full of politicians and generals frantically try to stop.',dr.-strangelove-or-how-i-learned-to-stop-worrying-and-love-the-bomb.jpg,,1964,1,'Group Capt. Lionel Mandrake / President Merkin Muffley / Dr. Strangelove, Gen. Buck Turgidson, Brig. Gen. Jack D. Ripper',95,'PG','Stanley Kubrick','Stanley Kubrick, Terry Southern',' Peter Sellers, George C. Scott, Sterling Hayden')
insert into movie_genre (movie_id, genre_id) values (49,14);
insert into movie_genre (movie_id, genre_id) values (49,15);	

insert into movie (movie_id, title, description, picture, year, country_id, characters, runtime, mature_rating_id, director, writer, stars) values ('Sunset Blvd.','A hack screenwriter writes a screenplay for a former silent-film star who has faded into Hollywood obscurity.',sunset-blvd..jpg,,1950,1,'Joe Gillis, Norma Desmond, Max Von Mayerling',110,'NR','Billy Wilder',' Charles Brackett, Billy Wilder',' William Holden, Gloria Swanson, Erich von Stroheim')
